...
{
    [Serializable]
    class ForeignStudFactory : Student, IFactory
    {
        ...
        public ForeignStudFactory() { }

        public ForeignStudFactory(string surname, string name, string patronymic, int age, string speciality, DateTime dateBirth, int course, int group,
        ...
        {
            return new AddressForeign(country, city, postcode, street, house, apt);
        }

        public IPlaceWork CreatePlaceWork(string company, string city, string position, int experience, string country)
        {
            return new PlaceWorkForeign(company, city, position, experience, country);
        }
