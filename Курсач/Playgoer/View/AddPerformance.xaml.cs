                                                ...
                                                && int.TryParse(strTime.Substring(0, 2), out hh) && int.TryParse(strTime.Substring(3, 2), out mm))
                        {
                            ...
                            try
                            {
                                ...
                                if (success && success2)
                                {
                                    ...
                                    {
                                        Theater thr = uow.Theaters.GetConcreteObjectByName(tNameBox.Text);
                                        ...
                                        if (thr != null)
                                        {
                                            ...
                                            if (uow.Performances.GetConcreteObjectByPNameThIdDatetime(pNameBox.Text, thr.Id, dateTime) == null)
                                            {
